<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体检类型" prop="tijianleixing">
          <el-input v-model="ruleForm.tijianleixing" 
              placeholder="体检类型" clearable  :readonly="ro.tijianleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体检类型" prop="tijianleixing">
              <el-input v-model="ruleForm.tijianleixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="体检套餐" prop="tijiantaocan">
          <el-input v-model="ruleForm.tijiantaocan" 
              placeholder="体检套餐" clearable  :readonly="ro.tijiantaocan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="体检套餐" prop="tijiantaocan">
              <el-input v-model="ruleForm.tijiantaocan" 
                placeholder="体检套餐" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="套餐内容" prop="taocanneirong">
          <el-input v-model="ruleForm.taocanneirong" 
              placeholder="套餐内容" clearable  :readonly="ro.taocanneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="套餐内容" prop="taocanneirong">
              <el-input v-model="ruleForm.taocanneirong" 
                placeholder="套餐内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="适宜人群" prop="shiyirenqun">
          <el-input v-model="ruleForm.shiyirenqun" 
              placeholder="适宜人群" clearable  :readonly="ro.shiyirenqun"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="适宜人群" prop="shiyirenqun">
              <el-input v-model="ruleForm.shiyirenqun" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="体检状态" prop="tijianzhuangtai">
          <el-select :disabled="ro.tijianzhuangtai" v-model="ruleForm.tijianzhuangtai" placeholder="请选择体检状态">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="体检状态" prop="tijianzhuangtai">
	      <el-input v-model="ruleForm.tijianzhuangtai"
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tijianleixing = true;
          ...
          if(o=='tijiantaocan'){
            this.ruleForm.tijiantaocan = obj[o];
	    this.ro.tijiantaocan = true;
            continue;
          }
          if(o=='taocanneirong'){
	    ...
	    this.ro.shiyirenqun = true;
          ...
          if(o=='tijianzhuangtai'){
            this.ruleForm.tijianzhuangtai = obj[o];
	    this.ro.tijianzhuangtai = true;
            continue;
          }
          if(o=='yuyueshijian'){
       ...
       this.ruleForm.tijianzhuangtai='未体检'
      }
      // 获取用户信息
      this.$http({
