...
public class TijianxiangmuController {
    ...
    public R save(@RequestBody TijianxiangmuEntity tijianxiangmu, HttpServletRequest request){
    	tijianxiangmu.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<TijianxiangmuEntity> wrapper = new EntityWrapper<TijianxiangmuEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = tijianxiangmuService.selectCount(wrapper);
