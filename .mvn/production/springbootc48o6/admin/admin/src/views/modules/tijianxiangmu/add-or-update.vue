<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="体检类型" prop="tijianleixing">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="体检套餐" prop="tijiantaocan">
          <el-select :disabled="ro.tijiantaocan" @change="tijiantaocanChange" v-model="ruleForm.tijiantaocan" placeholder="请选择体检套餐">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.tijiantaocan" label="体检套餐" prop="tijiantaocan">
...
export default {
  ...
  methods: {
    ...
    tijiantaocanChange () {
      this.$http({
        url: `follow/tijiantaocan/tijiantaocan?columnValue=`+ this.ruleForm.tijiantaocan,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.taocanneirong){
                this.ruleForm.taocanneirong = data.data.taocanneirong
              }
        } else {
          this.$message.error(data.msg);
        }
	...
	this.ruleForm.xiangmujieshao = this.ruleForm.xiangmujieshao.replace(reg,'../../../springbootc48o6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
